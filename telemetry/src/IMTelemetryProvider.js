...
define(
    ['./IMTelemetrySeries'],
    function (IMTelemetrySeries) {
        "use strict";

        var SOURCE = "im.source";

        function IMTelemetryProvider(adapter, $q) {
            var subscribers = {};
            ...
            adapter.listen(function (message) {
                ...
                packaged[SOURCE][message.id] =
                    new IMTelemetrySeries([message.value]);
                ...
                requestTelemetry: function (requests) {
                    ...
                    function addToPackage(history) {
                        packaged[SOURCE][history.id] =
                            new IMTelemetrySeries(history.value);
                    }
